...
public class Implicit_explicit {
	...
	public static void main(String[] args)
	{
		...
		// TODO Auto-generated method stub
				...
				//Implenting implicit wait it will applicable for all lines
				...
				*/
				...
				selectitems(veggie_list,products,driver);
				
				
				//Try to navigate to the cart that is selected by us
				driver.findElement(By.cssSelector("img[alt='Cart']")).click();
				
				//Proceed to checkout. I am going to use the text attribute because it is static text. If it is dynamic, it would be risky to use.
				driver.findElement(By.xpath("//button[text()='PROCEED TO CHECKOUT']")).click();
				
				//Entering coupon code and click apply
